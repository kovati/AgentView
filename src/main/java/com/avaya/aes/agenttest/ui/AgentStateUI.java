...
public final class AgentStateUI extends JFrame implements
	...
	private void setupDialog() {
		...
		setMaximizedBounds(new java.awt.Rectangle(0, 0, 410, 550));
		setResizable(false);
		...
		logoutButton.setBounds(295, 450, 75, 23);
		...
		answerButton.setBounds(125, 450, 80, 23);
		...
		dropButton.setBounds(215, 450, 70, 23);
		...
		setBounds((screenSize.width - 417) / 2, 
				(screenSize.height - 437) / 2, 500, 525);
